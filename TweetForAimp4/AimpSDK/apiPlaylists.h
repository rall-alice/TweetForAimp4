...
static const WCHAR* AIMP_PREIMAGEFACTORY_FOLDERS_ID = TEXT("TAIMPPlaylistFoldersPreimage");
static const WCHAR* AIMP_PREIMAGEFACTORY_MUSICLIBRARY_ID = TEXT("TAIMPMLPlaylistPreimage");
static const WCHAR* AIMP_PREIMAGEFACTORY_PLAYLIST_ID = TEXT("TAIMPPlaylistBasedPreimage");
